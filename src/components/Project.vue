  ...
  data: () => ({
    items: [
        ...
        },
        {
          ...
          link: 'https://smartland.netlify.com/'
        },
        {
          title: 'Piruma Admin',
          subtitle: 'Single web page application to manage room booking.',
          src: 'https://drive.google.com/uc?export=view&id=1na40C0M84QC5SHs4JpygEpDSe5NSlaLL',
